...
| ------------ | ------ | ------ | -------------------------------- |
| Availability | 7 days | 99.9%  | fast (14.4× / 2m), slow (1× / 30m) |
| Latency      | 10m    | 500ms avg | warning at 500ms, critical at 2s |
| Liveness     | 5m     | scrape up | critical                          |
| Idle         | 15m    | ≥ 1 msg / pipeline | warning                           |
